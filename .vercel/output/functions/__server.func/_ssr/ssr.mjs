...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BynQyGW7.mjs");
...
var manifest = {
	"09e676400a8352789b4a992a23c8be3bc225fd7138253dd211713e807e081f72": {
		functionName: "runEval_createServerFn_handler",
		importer: () => import("./ai-De5e3eC9.mjs")
	},
	"1049bad283d038fd5dcfd5c0770c49d53be8936991122557ded91c7c7ede0ea1": {
		functionName: "runPrompt_createServerFn_handler",
		importer: () => import("./ai-De5e3eC9.mjs")
	},
	"27e95d3e09f8192da2d32713d7f8ce87bf53d53933fb4757a1eda86c3e2194f3": {
		functionName: "improvePrompt_createServerFn_handler",
		importer: () => import("./ai-De5e3eC9.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-n8Gg9loh.mjs").then((n) => n.t),
